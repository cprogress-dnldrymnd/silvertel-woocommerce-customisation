...
class Silvertell_Woocommerce_Customisation
{
    ...
    public function add_settings_page()
    {
        add_submenu_page(
            'woocommerce',
            'Silvertell Advanced Customisations', // The browser tab / page title
            'Silvertell Settings',                // The WooCommerce sidebar menu text
            'manage_woocommerce',
            'silvertell-file-importer',           // Keeping the slug the same prevents 404s on refresh
