   ...
   /**
    ...
    public function print_child_product_modal()
    {
        ...
        <style>
            ...
            /* Ensures selectWoo dropdown and search input stay above the modal */
        ...
        <script>
            (function($) {
                 ...
                 * This prevents initialization failures if WooCommerce scripts load after our inline script.
                 */
                function getS2Fn() {
                ...
                $modal.on('click', '.dd-attr-create', function() {
                    ...
                    $.post(ajaxurl, { 
                        ...
                        // Native WC AJAX for this endpoint returns flat JSON on success, and wp_send_json_error on failure
                        if (res && res.term_id) {
    ...
    private function render_provider_buttons($post_id)
    {
        ...
        foreach ($this->get_sample_providers() as $provider) {
            ...
            $out .= '<a class="dd-buy-btn" href="' . esc_url($url) . '" target="_blank" rel="noopener nofollow" title="' . esc_attr($provider['name']) . '"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart3" viewBox="0 0 16 16"> <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5M3.102 4l.84 4.479 9.144-.459L13.89 4zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4m7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4m-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2m7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2"/> </svg>' . $inner . '</a>';
        }
        return $out;
    }
